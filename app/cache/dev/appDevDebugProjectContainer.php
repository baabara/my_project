...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'blogsymfony2', 'user' => 'blogsymfony2', 'password' => 'blogsymfony2', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\My\\BlogBundle\\Entity'))), 'My\\BlogBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MyBlogBundle' => 'My\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_580007498e35935d72af52b0d28e2633b47e4ce6af16fc3dd464cf8d7ab0bf20');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('303c2a59f35f47b688a0919f592d5f0558f96e90');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5613ff38e46075.17217341')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '303c2a59f35f47b688a0919f592d5f0558f96e90',
            'locale' => 'en',
            ...
            'kernel.secret' => '303c2a59f35f47b688a0919f592d5f0558f96e90',
            ...
            'assetic.ruby.bin' => 'C:\\cygwin64\\bin\\ruby.EXE',
